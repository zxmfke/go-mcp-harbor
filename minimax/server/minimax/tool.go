...
type TextToAudioRequest struct {
	...
	OutputDirectory string  `json:"output_directory,omitempty" description:"The directory to save the audio to, option."`
	...
	SampleRate      int     `json:"sample_rate,omitempty" description:"Sample rate, optional values [8000,16000,22050,24000,32000,44100], default 32000."`
...
// VoiceCloneRequest 声音克隆请求
type VoiceCloneRequest struct {
	VoiceID         string `json:"voice_id" description:"The id of the voice to use."`
	OutputDirectory string `json:"output_directory,omitempty" description:"The directory to save the audio to, option."`
...
type GenerateVideoRequest struct {
	...
	OutputDirectory string `json:"output_directory,omitempty" description:"The directory to save the video to, option."`
}
...
func RegisterTools(s *server.Server, mcp *MinimaxMCPServer) {
	// Text-to-speech tool
	...
	s.RegisterTool(textToAudioTool, func(req *protocol.CallToolRequest) (*protocol.CallToolResult, error) {
	...
	s.RegisterTool(listVoicesTool, func(req *protocol.CallToolRequest) (*protocol.CallToolResult, error) {
	...
	s.RegisterTool(voiceCloneTool, func(req *protocol.CallToolRequest) (*protocol.CallToolResult, error) {
	...
	s.RegisterTool(generateVideoTool, func(req *protocol.CallToolRequest) (*protocol.CallToolResult, error) {
	...
	s.RegisterTool(textToImageTool, func(req *protocol.CallToolRequest) (*protocol.CallToolResult, error) {
